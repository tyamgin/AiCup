    ...
    public partial class MyStrategy
    {
        ...
        void MoveFirstTicks()
        {
            ...
            ActionsQueue.Add(env =>
            {
                ...
                // create helicopters groups
                var helicoptersRect = Utility.BoundingRect(env.GetVehicles(true, VehicleType.Helicopter));
                var rects = helicoptersRect.Split4X();
