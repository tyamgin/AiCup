...
#endif
    system((runStr + " --duration 40000 --seed 183141093 --p2-name m17 --p2 tcp-31002 &").c_str());
    cerr << "local runner started" << endl;

    usleep(2000 * 1000);
    system("/Users/tyamgin/Projects/AiCup/CodeBall/release/m17 127.0.0.1 31002 0000000000000000 &");
#endif
